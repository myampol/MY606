...
```
##### This clearly shows that the median BMI for individuals who **do** exercise is `r median_BMI_with_exercise` while the median BMI for individuals who **do not** exercise is `r median_BMI_no_exercise` , for a difference of `r diff_BMI_exercise`  .
...
##### The **blue** line fits a linear regression through the data.  It has slope `r slope` and intersects the green line at ( x , y ) = (`r intersection`,`r intersection`).  The slope indicates that for each 1 lb. increase in actual weight, the fitted desired weight increases by only `r slope` lbs.
